...
export const Hero = ({
  ...
  return (
    <div className="container mx-auto flex h-screen flex-col items-center justify-center gap-1 p-4">
      ...
      <h1 className="max-w-3xl text-pretty text-center text-3xl font-bold leading-8 tracking-tight text-blue-950 xs:text-4xl sm:text-6xl  backdrop-blur-sm">
    ...
    <div className="my-10 last:mb-0 first:mt-0 flex flex-col justify-center items-center w-full px-4 py-8 rounded-md max-w-md bg-white/5 backdrop-blur-sm">
